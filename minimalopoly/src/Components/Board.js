...
export default class Board extends Component {
    ...
    render() {
        return (
            ...
            <div className="board">
    <div className="die1" id="die1" style={{position: "inherit",
  background: this.state.background1,
  width: "70px",
  height: "70px",
  transform: "translate(700px, 100px)"}}></div>
    <div className="die2" id="die2" style={{position: "inherit",
  background: this.state.background2,
  width: "70px",
  height: "70px",
  transform: "translate(800px, 100px)"}}></div>
    <button className="roll" onClick={this.roll}>Roll</button>
    <button id="0" className="go"></button>
    <button id="1" className="br1"></button>
